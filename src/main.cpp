...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa997ac0b7e7018d87cd60625703ded7dfcc74a3d0f3ab38ae4121b819e89cd1a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nNonce   = 12314332;

        if (fTestNet)
        {
            block.nTime    = 1392846434;
            block.nNonce   = 1524906470;
        }
