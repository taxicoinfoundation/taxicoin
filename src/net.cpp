...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Taxicoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"taxicoin.info", "dnsseed.taxicoin.info"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"taxicoin.info", "testnet-seed.taxicoin.info"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Taxicoin is probably already running."), addrBind.ToString().c_str());
        else
